...
public class AmmoManager : MonoBehaviour
{
    ...
    {
        if (ammoID1.id == weaponUniqueID) ResetAmmo(ammoID1);
        else if (ammoID2.id == weaponUniqueID) ResetAmmo(ammoID2);
    }
    ...
    {
        if (ammoID1.id == weaponUniqueID) SetAmmo(currentAmmo, maxAmmo, ammoID1);
        else if (ammoID2.id == weaponUniqueID) SetAmmo(currentAmmo, maxAmmo, ammoID2);
    }
}
